...
<div class="row small-uncollapse">
    <div class="small-12 medium-8 columns">
        ...
        <div class="orbit" role="region" aria-label="GoSciences Accueil" data-orbit>
        <ul class="orbit-container">
          <button class="orbit-previous"><span class="show-for-sr">Previous Slide</span>&#9664;&#xFE0E;</button>
          <button class="orbit-next"><span class="show-for-sr">Next Slide</span>&#9654;&#xFE0E;</button>
		<li class="is-active orbit-slide">
            <img class="orbit-image" src="<?=img_url('reussite-examens-2017-opti.png')?>" alt="100% de réussite aux examens nationnaux en 2017 !">
            <figcaption class="orbit-caption">Toute l'équipe de GoSciences félicite et est fière d'avoir pu contribuer à la réussite de tous ses élèves !</figcaption>
          </li>
	...
	<button class="is-active" data-slide="0"><span class="show-for-sr">Toute l'équipe de GoSciences félicite et est fière d'avoir pu contribuer à la réussite de tous ses élèves !</span><span class="show-for-sr">Current Slide</span></button>
          <button data-slide="1"><span class="show-for-sr">L'art de la réussite consiste à savoir s'entourer des meilleurs</span></button>
          <button data-slide="2"><span class="show-for-sr">GoSciences interviewé par la République du Centre à propos du soutien scolaire (voir l'article)</span></button>
